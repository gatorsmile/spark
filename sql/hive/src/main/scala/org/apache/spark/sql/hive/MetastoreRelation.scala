...
class HiveRelationProvider extends CatalogSchemaRelationProvider with DataSourceRegister {
  ...
  override def createRelation(
      ...
      catalogTable: CatalogTable): BaseRelation = {
...
/**
 * Logical plan node for representing insertion into Hive table.
